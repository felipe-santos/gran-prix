...
/**
 * Play / Pause / Reset controls for the Flappy Bird demo.
 * Same structure as GameControls.tsx — reuses the shared Button + lucide-react icons.
 */
export const FlappyControls: React.FC<FlappyControlsProps> = ({
    isPlaying,
    onTogglePlay,
    onReset,
}) => {
