...
/**
 * Play / Pause / Reset controls for the Bipedal Walker demo.
 * Same structure as FlappyControls — reuses the shared Button + lucide-react icons.
 */
export const WalkerControls: React.FC<WalkerControlsProps> = ({
    isPlaying,
    onTogglePlay,
    onReset,
}) => {
