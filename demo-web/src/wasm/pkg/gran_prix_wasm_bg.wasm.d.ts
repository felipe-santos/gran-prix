...
export const neuralbrain_new: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const population_new: (a: number, b: number, c: number, d: number) => [number, number, number];
